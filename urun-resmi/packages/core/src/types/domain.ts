...
export interface Product {
  ...
  // Absolute-from-server path (e.g. "/api/uploads/products/<uuid>.jpg") —
  // prepend the API base URL to render it; null when no photo has been
  // uploaded. Set via productsApi.uploadProductImage, never through the
  // regular create/update payload (it's its own multipart endpoint).
